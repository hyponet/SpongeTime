...
public class BasicTemplate {
    ...
    public String getContent(){
        ...
        String rnt = "<body style=\"background-color: #f2f4f8\"><div style=\"margin-top: 10px; width: 80%; margin-left: 10%;box-shadow:2px 2px 5px #ccc;\">"+
                "<div id=\"HEADER\" style=\"padding: 15px; background-color: #000; border-radius:15px 15px 0px 0px;\"><a class=\"navbar-brand\" href=\"http://todo.updev.cn\" style=\"text-decoration:none; color: #fff; font-size: 18px;\"><span style=\"color: #30a5ff; padding-left: 10px;\">SPONGE</span>TIME</a><span style=\"color: #ccc; font-size: 13px; padding: 10px;\"> 一个用心的时间助手</span></div>"+
